...
if(isset($_SESSION['auth_faculty'])){
  $_SESSION['status_faculty']="You are already logged In";
...
if(isset($_SESSION['auth_status_faculty']))
{
  ?>
  <div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Hey!</strong> <?php echo $_SESSION['auth_status_faculty']; ?>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
   </button>
  </div>
  <?php
  unset($_SESSION['auth_status_faculty']);
}
?>
      
              <form class="pt-3" action="logincode.php" method="POST">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="f_username" id="exampleInputEmail1" placeholder="Username">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" name="f_password" id="exampleInputPassword1" placeholder="Password" onkeyup ="return verifyPassword()">
                </div>
