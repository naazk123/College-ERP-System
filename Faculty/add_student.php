              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="" id="myForm">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">FE I Sem Seat No</label>
                      <input type="text" class="form-control" id="examplepancard" Name="s_FE_I" placeholder="Enter the FE I Sem Seat No">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">FE II Sem Seat No</label>
                      <input type="text" class="form-control" id="examplepancard" Name="s_FE_II" placeholder="Enter the FE II Sem Seat No">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">SE I Sem Seat No</label>
                      <input type="text" class="form-control" id="examplepancard" Name="s_SE_I" placeholder="Enter the SE I Sem Seat No">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">SE II Sem Seat No</label>
                      <input type="text" class="form-control" id="examplepancard" Name="s_SE_II" placeholder="Enter the SE II Sem Seat No">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">TE I Sem Seat No</label>
                      <input type="text" class="form-control" id="examplepancard" Name="s_TE_I" placeholder="Enter the TE I Sem Seat No">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">TE II Sem Seat No</label>
                      <input type="text" class="form-control" id="examplepancard" Name="s_TE_II" placeholder="Enter the TE II Sem Seat No">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">BE I Sem Seat No</label>
                      <input type="text" class="form-control" id="examplepancard" Name="s_BE_I" placeholder="Enter the BE I Sem Seat No">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">BE II Sem Seat No</label>
                      <input type="text" class="form-control" id="examplepancard" Name="s_BE_II" placeholder="Enter the BE II Sem Seat No">
                    </div>
                    <div class="form-group">
...
$query="INSERT INTO `stud_info`(`s_name`, `s_institute`, `s_branch`, `s_class_year`, `s_mb_no`, `s_email`, `s_blood_grp`, `s_address`, `s_city`, `s_state`, `s_pin`, `s_parent_mb_no`, `s_parent_email`, `s_roll_no`, `s_prn`, `s_dob`, `s_mother_name`, `s_batch`, `s_admit_year`, `s_passout_year`, `s_active_status`, `s_dsy`, `s_FE_I`, `s_FE_II`, `s_SE_I`, `s_SE_II`, `s_TE_I`, `s_TE_II`, `s_BE_I`, `s_BE_II`, `s_username`, `s_password`, `s_status`) VALUES ('$s_name', '$s_institute', '$s_branch', '$s_class_year', '$s_mb_no', '$s_email', '$s_blood_grp', '$s_address', '$s_city', '$s_state', '$s_pin', '$s_parent_mb_no', '$s_parent_email', '$s_roll_no', '$s_prn', '$s_dob', '$s_mother_name', '$s_batch', '$s_admit_year', '$s_passout_year', '$s_active_status', '$s_dsy', '$s_FE_I', '$s_FE_II', '$s_SE_I', '$s_SE_II', '$s_TE_I', '$s_TE_II', '$s_BE_I', '$s_BE_II', '$s_username', '$s_password','1')";
