        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <?php
                ...
                // // echo $_GET['s_roll_no'];
                // require 'db.php';
                // $select = "select s_cname,s_course from subject_info where s_roll_no ='".$_GET['s_roll_no']."';";
                // $val= array();
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <?php
                    ...
                    //     $select = "select s_name, s_roll_no from stud_info where s_cname='$course_name' and s_batch='$batch'";
                  ...
                  <form class="forms-sample" method="POST" name="th_data" action="" id="myForm">
                    <table width="100%">
                        ...
                        // extract($_POST);
                            ...
                            // echo $batch;
                            require 'db.php';
                            $select = "select s_name, s_roll_no from stud_info where s_batch='$batch'";
                            if ($result = $con->query($select))
                            {
                                $index = 1;
                                while ($data = $result->fetch_assoc())
...
extract($_POST);
  ...
  // {  
      require 'db.php';
      $select = "select s_cname,s_course from subject_info where s_roll_no ='".$_SESSION['s_roll_no']."';";
      $val= array();
      if ($result = $con->query($select))
      {
        while ($data = $result->fetch_assoc())
      ...
      $select = "select s_name, s_roll_no from stud_info;";
      $val= array();
      $index =0;
      if ($result = $con->query($select))
      {
          ...
          {
            // echo implode($data);
            $innerarr = array($data['s_name'], $data['s_roll_no']);
            $val[$index] = $innerarr;
            $index = $index + 1;
            // echo $data['s_cname'];
          }
      ...
      if ($asd)
      {
          ...
          echo 'window.location.href = "view_university_th_marks.php?s_roll_no='.$_SESSION['s_roll_no'].'";';
          echo '</script>';
      }
      else
      {
          echo '<script type="text/javascript">';
          echo 'window.location.href = "add_university_th_marks.php?s_roll_no='.$_SESSION['s_roll_no'].'";';
          echo '</script>';
      }
  }
?>
