  ...
  // {  
    ...
    require 'db.php';
      ...
      if ($asd)
      {
          ...
          echo 'window.location.href = "view_university_th_marks.php?s_roll_no='.$_GET['s_roll_no'].'";';
          echo '</script>';
      }
      else
      {
          echo '<script type="text/javascript">';
          echo 'window.location.href = "edit_university_th_marks.php?s_roll_no='.$_GET['s_roll_no'].'";';
          echo '</script>';
      }
  }
?>